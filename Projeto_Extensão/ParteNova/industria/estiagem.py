...
# Filtrar as linhas que contêm 'Estiagem e Seca' na coluna 'descricao_tipologia'
...
print("Quantidade de casos de 'Estiagem e Seca' com 'PEPR_Indústria (R$)' > 0 entre 2020 e 2023 nos estados SP, RJ, MG, ES:")
