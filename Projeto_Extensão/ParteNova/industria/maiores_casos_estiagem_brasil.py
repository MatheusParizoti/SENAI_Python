...
chuvas_intensas = df[df['descricao_tipologia'].str.contains('Estiagem e Seca', case=False, na=False)]
...
chuvas_intensas_com_valor_anos = chuvas_intensas_com_valor[
    chuvas_intensas_com_valor['Data_Evento'].dt.year.between(2013, 2019)
]

# Contar a quantidade de casos por estado
quantidade_casos_por_estado = chuvas_intensas_com_valor_anos.groupby('Sigla_UF').size().sort_values(ascending=False)

# Exibir os resultados
print("Quantidade de casos de 'Chuvas Intensas' com 'PEPR_Indústria (R$)' > 0 entre 2020 e 2023 por estado:")
