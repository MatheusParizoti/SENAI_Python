...
df_ano_sudeste = df_sudeste.groupby(['Ano', 'Sudeste'])['PEPR_Indústria (R$)'].sum().reset_index()

# 5. Arredondar os valores de PEPR_Indústria (R$) para 7 casas decimais
df_ano_sudeste['PEPR_Indústria (R$)'] = df_ano_sudeste['PEPR_Indústria (R$)'].round(7)

# 6. Plotar o gráfico exponencial (logaritmo de PEPR_Indústria)
plt.figure(figsize=(10, 6))
sns.lineplot(data=df_ano_sudeste, x='Ano', y='PEPR_Indústria (R$)', hue='Sudeste', marker='o')
